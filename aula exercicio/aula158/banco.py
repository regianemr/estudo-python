...
class Banco:
    ...
    def _checa_cliene(self, cliente):
    ...
    def autenticar(self, cliente: pessoas.Pessoa, conta: contas.Conta):
        ...
        self._checa_cliene(cliente) and\
...
if __name__ == '__main__': 
    ...
    c1 = pessoas.Cliente('Gleison', 34)
    cc1 = contas.ContaCorrente(111, 222, 0, 0)
    c1.conta = cc1
    c2 = pessoas.Cliente('Regiane', 28)
    cp1 = contas.ContaPoupanca(342, 245, 100)
    c2.conta = cp1
    banco = Banco()
